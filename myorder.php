            ...
            <div class="check_w3ls">
				...
				<div class="checkout-right">
                    <table class="timetable_sub">
						...
						$c=0;
						$u_id=$_SESSION['u_id'];
                        $q= "select o.p_id, o.qty, p.name, p.detail,p.photo, p.price from ordermaster o join product p 
                        on o.p_id=p.p_id where u_id='$u_id'";
						// $q="select * from ordermaster where u_id='$u_id'";
						...
						?>
                            <tr class="rem1">
                                ...
                                <td class="invert"><?php print $row['qty']?></td>
