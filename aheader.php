    ...
    <header>
        <div class="container">
            ...
            <nav class="top_nav d-flex pt-3 pb-1">
                <!-- logo -->
                <h1>
                    <a class="navbar-brand" href="#" style="font-size:50px">Gadget Shop
                    </a>
                </h1>
                <!-- //logo -->
                        ...
                        <li class="nav-item dropdown has-mega-menu" style="position:static;">
                            ...
                            <div class="dropdown-menu" style="margin-left:250px">
                                        <div class="col-md-4 text-center" style="width:250px">
                                            ...
                                            <a class="dropdown-item" href="viewcategroy.php">View</a>
                                </div>
                            </div>
                        </li>
                        <li class="nav-item dropdown has-mega-menu" style="position:static;">
                            ...
                            <div class="dropdown-menu" style="margin-left:400px">
                                        <div class="col-md-4 text-center" style="width:250px">
                                            ...
                                            <a class="dropdown-item" href="viewproduct.php">View</a>
                                </div>
                            </div>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="viewuser.php">User</a>
                        </li>
