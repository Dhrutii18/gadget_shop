    ...
    <div class="container fluid">
      ...
      <form id="redirectForm" method="post" action="request.php">
        <div class="form-group">
          ...
          <input class="form-control" name="appId" value="TEST1041276579bf61c30bb20b3d390e56721401" />
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <input class="form-control" name="orderAmount" value="200"/>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <input class="form-control" name="returnUrl" value="http://localhost/razorpay/checkout/response.php"/>
        </div>        
        <div class="form-group">
